...
const addition = sum(numbers);
const addition_pos = sum(numbers.filter(curr => curr > 0));
const addition_even = sum(numbers.filter(curr => curr % 2 === 0));
const addition_greater = sum(numbers.filter(curr => curr > 400));
const addition_idx = sum(numbers.filter((curr, idx) => idx >= 20 && idx <= 40));

console.log(`Sum = ${addition}`);
console.log(addition_pos);
console.log(addition_even);
console.log(addition_greater);
console.log(addition_idx);